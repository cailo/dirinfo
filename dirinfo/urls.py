...
from curriculums import urls as curriculums_urls
from billboard import urls as billboard_urls
...
urlpatterns = [
    ...
    url(r'^billboard/',
        include(billboard_urls, namespace='billboard')
        ),
    url(r'^expedients/',
        include(expedients_urls, namespace='expedients')
        ),
    url(r'^curriculums/',
        include(curriculums_urls, namespace='curriculums')
        ),
    url(r'^admin/',
